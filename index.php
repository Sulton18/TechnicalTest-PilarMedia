  ...
  <head>
    ...
    <title>TERSERAH KARYAWAN - Home</title>
    ...
    <main class="side-main">
          ...
          <div class="row">
            <div class="col-lg-7">
              ...
              <div class="hero-banner__img">
                <img class="img-fluid" src="img/karyawan.png" alt="">
              </div>
            </div>
      ...
      <footer class="footer-area section-gap">
        ...
        <div class="footer-bottom row align-items-center text-center text-lg-left">
          ...
          <center>
            <p class="footer-text m-0 col-lg-8 col-md-12"> Copyright &copy;<script>
                document.write(new Date().getFullYear());
              </script> Terserah Developer | Pilar Media Indonesia <i class="fa fa-heart" aria-hidden="true"></i> by <a  target="_blank">Sulon Aji Darmawan</a></p>
          </center>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
